...
exports.getTourDetails = async(req, res, next) => {
  try{
    ...
    res.render("pages/TripDetails" , { trips: tripdetails[0] });
  } 
...
exports.postBookTrip = (req, res, next) => {
  ...
  .then(result => {
    ...
    var mailOptions = {
      ...
      attachments: {filename: userproof , path: 'images/proofs/' + userproof },
      html: regbody,
    };
...
exports.postEdit = async(req, res, next) => {
  ...
  try{
    ...
    res.render("pages/edittrip", { trips: tripdetails[0] });
...
exports.getAccomodationsDetails = async(req, res, next) => {
  ...
  try{
    ...
    res.render("pages/AccomodationsDetails" , { accod: accoddetails[0] });
  } 
...
exports.getStateFilters = async(req, res, next) => {
  ...
  try{
    ...
    res.render("pages/StateFilter" , { Tours: alltours });
  } 
...
exports.getToursAddimage = async(req, res, next) => {
  ...
  res.render("pages/addimages", {trip : tripfilter});
...
exports.getDownloadPDF = (req, res, next) => {
  ...
  .then((data) => {
    ...
    pdfDoc.moveUp();
    pdfDoc.moveUp();
    pdfDoc.fontSize(25).font('Times-Roman').fillColor('green').text('Trekker Details', { align : 'center'});
...
exports.getAccodAddImage = async(req, res, next) => {
  ...
  res.render("pages/accodaddimages", {accod : accodfilter});
...
exports.postBookDate = (req, res,next) => {
